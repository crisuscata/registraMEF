...
/**
 * MS_TEMA ENTIDAD: ALMACENA LOS TEMAS REGISTRADOS EN EL SISTEMA "TEMAS"
 * 
...
@Entity
@Table(name = "MS_TEMA")
public class MsTema implements java.io.Serializable {


	/**
	 * 
	 */
	private static final long serialVersionUID = 213400290941373794L;
	...
	@SequenceGenerator(name = "G_MS_TEMA", sequenceName = PropertiesMg.ESQUEMA + "SQ_MS_TEMA", allocationSize = 1)
@GeneratedValue(strategy = SEQUENCE, generator = "G_MS_TEMA")
@Id
@Column(name = "ID_TEMA", unique = true, nullable = false, precision = 10, scale = 0)
...
@Column(name = "TIPO_SERVICIO", precision = 10, scale = 0)
