...
/**
 * DT_ENTIDADES_USUEXTERNOS ENTIDAD: ALMACENA LAS ENTIDADES A LA QUE PERTENECE EL USUARIO EXTERNO "ENTIDAD DEL USUARIO EXTERNO"
 * 
 ...
 */
@Entity
@Table(name = "DT_ENTIDADES_USUEXTERNOS")
public class DtEntidadesUsuexternos implements java.io.Serializable {


	/**
	 * 
	 */
	private static final long serialVersionUID = -8068006184643345987L;
	...
	public DtEntidadesUsuexternos() {
	}

	@SequenceGenerator(name = "G_DT_ENTIDADES_USUEXTERNOS", sequenceName = PropertiesMg.ESQUEMA + "SQ_DT_ENTIDADES_USUEXTERNOS", allocationSize = 1)
@GeneratedValue(strategy = SEQUENCE, generator = "G_DT_ENTIDADES_USUEXTERNOS")
@Id
@Column(name = "ID_USUEXT_ENTI", unique = true, nullable = false, precision = 10, scale = 0)
