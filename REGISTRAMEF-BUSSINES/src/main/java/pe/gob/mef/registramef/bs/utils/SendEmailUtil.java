...
public class SendEmailUtil implements Serializable,TransportListener, ConnectionListener{
	...
	public void sendEmail(String toEmail,String coEmail,String ccEmail, String subject, String body, String filepath){
		System.out.println("SendEmailUtil.sendEmail("+toEmail+", "+coEmail+", "+ccEmail+", "+subject+")");
		if(debug)
...
//			msg.setFrom(new InternetAddress(fromEmail, "NoReply-JD"));
			msg.setFrom(new InternetAddress(fromEmail, "CONECTAMEF"));
...
//			msg.setFrom(new InternetAddress("no_reply@example.com", "NoReply-JD"));
			msg.setFrom(new InternetAddress("no_reply@example.com", "CONECTAMEF"));
