...
/**
 * DT_ASISTENCIA_USUEXTERNOS ENTIDAD: ALMACENA LOS USUARIOS QUE BRINDAN LA ATENCION EN LA ASISTENCIA TECNICA "USUARIOS QUE BRINDAN LA ATENCIÓN"
 * 
 ...
 */
@Entity
@Table(name = "DT_ASISTENCIA_USUEXTERNOS")
public class DtAsistenciaUsuexternos implements java.io.Serializable {


	/**
	 * 
	 */
	private static final long serialVersionUID = 5474423566003109935L;
	...
	public DtAsistenciaUsuexternos() {
	}

	@SequenceGenerator(name = "G_DT_ASISTENCIA_USUEXTERNOS", sequenceName = PropertiesMg.ESQUEMA + "SQ_DT_ASISTENCIA_USUEXTERNOS", allocationSize = 1)
@GeneratedValue(strategy = SEQUENCE, generator = "G_DT_ASISTENCIA_USUEXTERNOS")
@Id
@Column(name = "ID_ASIST_USUEXT", unique = true, nullable = false, precision = 10, scale = 0)
...
@Column(name = "CTRL_CONFIRMACION", precision = 38, scale = 0)
