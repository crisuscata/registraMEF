...
/**
 * DT_ASISTENCIA_PROYECTO BAKING: LISTA DE LOS DISTINTOS PROYECTOS DE INVERSIÓN RELACIONADOS A LA ASISTENCIA TÉCNICA
 * 
 ...
 * 
 */
public class DtAsistenciaProyectoBk implements java.io.Serializable {

	//ID
	private Long idAsistProyecto;
	...
	private DtAsistenciaProyectoACL dtAsistenciaProyectoACL = null;		
		
	public DtAsistenciaProyectoBk() {
	}
...
public String getNombre() {
	...
	public DtAsistenciaProyectoACL getDtAsistenciaProyectoACL() {
		return dtAsistenciaProyectoACL;
	}

	public void setDtAsistenciaProyectoACL(DtAsistenciaProyectoACL dtAsistenciaProyectoACL) {
		this.dtAsistenciaProyectoACL = dtAsistenciaProyectoACL;
	}
