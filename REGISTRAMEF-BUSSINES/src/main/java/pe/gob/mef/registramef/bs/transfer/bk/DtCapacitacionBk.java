...
/**
 * DT_CAPACITACION BAKING: LISTA DE LOS DATOS REGISTRADOS EN UNA CAPACITACIÓN
 * 
 ...
 * 
 */
public class DtCapacitacionBk implements java.io.Serializable {
	...
	private DtCapacitacionACL dtCapacitacionACL = null;	
	...
	//MPINARES 14022024 - INICIO
		...
		private List<String> entidades = null;
	...
	public DtCapacitacionACL getDtCapacitacionACL() {
		return dtCapacitacionACL;
	}

	public void setDtCapacitacionACL(DtCapacitacionACL dtCapacitacionACL) {
		this.dtCapacitacionACL = dtCapacitacionACL;
	}
    ...
    public boolean isFinalizado() {
		...
		if (estado!=null && estado.longValue()==estadoFinalizado.longValue()){
			finalizado=true;
		}
		return finalizado;
	}
	...
	public boolean isAnulado() {
		...
		if (estado!=null && estado.longValue()==estadoEliminado.longValue()){
			anulado=true;
		}
		return anulado;
	}
	...
	public String getTemasTxt() {
		...
		if (getTemas() != null && getTemas().size() > 0) {
			for (String objeto : getTemas()) {
	...
	public String getEntidadesTxt() {
		StringBuffer sb = new StringBuffer();
		if (getEntidades() != null && getEntidades().size() > 0) {
			for (String objeto : getEntidades()) {
				sb.append(objeto.toString()+", ").append('\n');
			}
		}
		return sb.toString();
