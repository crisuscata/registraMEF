...
/**
 * MS_SIS_ADMISTRATIVO BAKING: LISTA DE LOS SISTEMAS ADMINISTRATIVOS REGISTRADOS EN EL SISTEMA
 * 
 ...
 * 
 */
public class MsSisAdmistrativoBk implements java.io.Serializable {
	...
	private MsSisAdmistrativoACL msSisAdmistrativoACL = null;		
		
	public MsSisAdmistrativoBk() {
	}
	...
	public MsSisAdmistrativoACL getMsSisAdmistrativoACL() {
		return msSisAdmistrativoACL;
	}

	public void setMsSisAdmistrativoACL(MsSisAdmistrativoACL msSisAdmistrativoACL) {
		this.msSisAdmistrativoACL = msSisAdmistrativoACL;
	}
