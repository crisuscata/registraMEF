...
public class DtEncuestaLC implements Serializable  {
	...
	public List<DtEncuestaBk> getData() {
		return data;
	}

	public void setData(List<DtEncuestaBk> data) {
		this.data = data;
	}
