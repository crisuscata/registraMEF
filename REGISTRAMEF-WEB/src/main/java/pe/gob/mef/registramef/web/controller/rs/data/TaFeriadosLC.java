...
public class TaFeriadosLC implements Serializable  {
	...
	public List<TaFeriadosBk> getData() {
		return data;
	}

	public void setData(List<TaFeriadosBk> data) {
		this.data = data;
	}
