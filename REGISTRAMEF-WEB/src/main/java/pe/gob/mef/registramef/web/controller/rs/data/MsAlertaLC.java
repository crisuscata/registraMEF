...
public class MsAlertaLC implements Serializable  {
	...
	public List<MsAlertaBk> getData() {
		return data;
	}

	public void setData(List<MsAlertaBk> data) {
		this.data = data;
	}
