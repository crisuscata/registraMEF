...
@XmlRootElement
public class MsProyectoInversionLC implements Serializable  {

	protected long contador = 0;
	private long tiempoenBD = 0;
	private long tiempoenproceso = 0;
	private boolean creamodifica = false;
	protected List<MsProyectoInversionBk> data = null;
	
	public MsProyectoInversionLC() {
	}
	...
	public List<MsProyectoInversionBk> getData() {
		return data;
	}

	public void setData(List<MsProyectoInversionBk> data) {
		this.data = data;
	}
