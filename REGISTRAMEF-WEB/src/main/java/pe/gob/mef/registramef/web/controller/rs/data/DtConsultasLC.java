...
public class DtConsultasLC implements Serializable  {
	...
	public List<DtConsultasBk> getData() {
		return data;
	}

	public void setData(List<DtConsultasBk> data) {
		this.data = data;
	}
