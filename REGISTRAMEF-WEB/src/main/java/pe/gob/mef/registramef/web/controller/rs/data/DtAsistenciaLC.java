...
public class DtAsistenciaLC implements Serializable  {
	...
	public List<DtAsistenciaBk> getData() {
		return data;
	}

	public void setData(List<DtAsistenciaBk> data) {
		this.data = data;
	}
