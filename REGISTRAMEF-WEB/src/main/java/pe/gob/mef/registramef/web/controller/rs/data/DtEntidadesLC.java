...
public class DtEntidadesLC implements Serializable  {
	...
	public List<DtEntidadesBk> getData() {
		return data;
	}

	public void setData(List<DtEntidadesBk> data) {
		this.data = data;
	}
