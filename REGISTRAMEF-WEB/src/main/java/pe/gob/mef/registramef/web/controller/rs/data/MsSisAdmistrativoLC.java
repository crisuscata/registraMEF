...
@XmlRootElement
public class MsSisAdmistrativoLC implements Serializable  {

	protected long contador = 0;
	private long tiempoenBD = 0;
	private long tiempoenproceso = 0;
	private boolean creamodifica = false;
	protected List<MsSisAdmistrativoBk> data = null;
	
	public MsSisAdmistrativoLC() {
	}
	...
	public List<MsSisAdmistrativoBk> getData() {
		return data;
	}

	public void setData(List<MsSisAdmistrativoBk> data) {
		this.data = data;
	}
