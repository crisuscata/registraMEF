...
var activardtAmpliacionFechaUrl = contexto+"/rs/ctrldtAmpliacionFecha/activardtAmpliacionFecha";
var eliminarListadtAmpliacionFechaUrl = contexto+"/rs/ctrldtAmpliacionFecha/eliminarListadtAmpliacionFecha";
...
estadoTxt: null,
	  ...
	  $scope.cleardtAmpliacionFecha = function(){
		    ...
		    $scope.dtAmpliacionFechaModelo.fechaInicio = new Date();$scope.dtAmpliacionFechaModelo.fechaFin = new Date();$scope.dtAmpliacionFechaModelo.fechaModif = new Date();$scope.dtAmpliacionFechaModelo.estado = null;
...
$scope.dtAmpliacionFechaModelo.fechaModif = dtAmpliacionFechaBk.fechaModif;
                        if(!$scope.isNull($scope.dtAmpliacionFechaModelo.fechaModif) && !isNaN($scope.dtAmpliacionFechaModelo.fechaModif)){
			    $scope.dtAmpliacionFechaModelo.fechaModif = new Date($scope.dtAmpliacionFechaModelo.fechaModif);
		        }
$scope.dtAmpliacionFechaModelo.estado = dtAmpliacionFechaBk.estado;
...
//		    				$scope.datos.push(dato); 
	   ...
	   $scope.eliminardtAmpliacionFecha = function(ev,dtAmpliacionFechaBk){		
            ...
            $scope.activardtAmpliacionFecha = function(ev,dtAmpliacionFechaBk){		
				    ev.target.disabled = true;
				    $scope.setDtAmpliacionFechaModelo(dtAmpliacionFechaBk);
				    var datainsert = angular.toJson($scope.dtAmpliacionFechaModelo);
		 			console.log("Activar = "+datainsert);	
	        		$http.post(activardtAmpliacionFechaUrl,datainsert,{headers: {'Content-Type': 'application/json'}}).then(function(res){
						var dato = res.data;
						var instrumentos = $scope.datos;
				        var index = $scope.datos.findIndex(obj => obj.idAutorizacion === dato.idAutorizacion);
						console.log("INDEX " + index);
            ...
            $scope.eliminarListadtAmpliacionFecha = function(ev){		
				    ev.target.disabled = true;
					...
					return;
				             ...
				             listaids.push($scope.selected[i].idAutorizacion);
			                 }
                                    } 
				    
				    var datainsert = angular.toJson(listaids);
		 			console.log("Elimiar = "+datainsert);	
	        		$http.post(eliminarListadtAmpliacionFechaUrl,datainsert,{headers: {'Content-Type': 'application/json'}}).then(function(res){
						var dato = res.data;
						$mdDialog.show(
					$mdDialog.alert()
					.parent(angular.element(document.body))
		...
		$scope.showConfirm = function(ev, dtAmpliacionFechaBk) {
                ...
                $scope.showConfirmActivar = function(ev, dtAmpliacionFechaBk) {
				    var confirm = $mdDialog.confirm()
				      .title('Activar Ampliaciones')
				    ...
				    $mdDialog.show(confirm).then(function () {
				      $scope.status = 'SI';
				      $scope.activardtAmpliacionFecha(ev, dtAmpliacionFechaBk);
				    }, function () {
				      $scope.status = 'NO';
				    });
				  };
                ...
                $scope.showConfirmLista = function(ev) {
				    ...
				    $mdDialog.show(confirm).then(function () {
				      $scope.status = 'SI';
				      $scope.eliminarListadtAmpliacionFecha(ev);
				    }, function () {
				      $scope.status = 'NO';
				    });
				  };		  
...
//	if($scope.isArray($scope.listaPrtParametrosTipoFechaCorte)){
//		var obj = $scope.listaPrtParametrosTipoFechaCorte.find(o => o.id === newValue);
