...
var listadtAsistenciaTemasUrl = contexto+"/rs/ctrldtAsistenciaTemas/listadtAsistenciaTemas";
var insertdtAsistenciaTemasUrl = contexto+"/rs/ctrldtAsistenciaTemas/salvardtAsistenciaTemas";
var eliminardtAsistenciaTemasUrl = contexto+"/rs/ctrldtAsistenciaTemas/eliminardtAsistenciaTemas";
var activardtAsistenciaTemasUrl = contexto+"/rs/ctrldtAsistenciaTemas/activardtAsistenciaTemas";
var eliminarListadtAsistenciaTemasUrl = contexto+"/rs/ctrldtAsistenciaTemas/eliminarListadtAsistenciaTemas";
var editardtAsistenciaTemasUrl = contexto+"/rs/ctrldtAsistenciaTemas/editardtAsistenciaTemas/";
var listaMsTemaidTemaIdTemaUrl = contexto+"/rs/ctrldtAsistenciaTemas/listaMsTemaIdTemaIdTema";
var listaMsSubtemaidSubtemaIdSubtemaUrl = contexto+"/rs/ctrldtAsistenciaTemas/listaMsSubtemaIdSubtemaIdSubtema";
var descargarUrl = contexto+"/rs/ctrldtAsistenciaTemas/descargar/";

///URLs CARGA DE ARCHIVOS
var insertDocUrl = contexto+"/rs/ctrldtAsistenciaTemas/insertarchivo";
///FIN URLs CARGA DE ARCHIVOS

var descargarvistaUrl = contexto+"/rs/ctrldtAsistenciaTemas/descargarvista";
...
myapp.config(function($routeProvider) {
	  $routeProvider
	  .when("/editar/:idAsistTema", {
		  templateUrl : "adminis/editardtAsistenciaTemas.html",
		  controller : "ctrlListadtAsistenciaTemas"
	  })
	  .when("/nuevo", {
		  templateUrl : "adminis/editardtAsistenciaTemas.html",
		  controller : "ctrlListadtAsistenciaTemas"
	  ...
	  .otherwise({
		  templateUrl : "adminis/verdtAsistenciaTemas.html",
		  controller : "ctrlListadtAsistenciaTemas"  
	  });
	});
...
myapp.controller('ctrlListadtAsistenciaTemas', ['$mdEditDialog', '$scope', '$timeout', '$http', '$mdDialog','$location','$routeParams', '$mdPanel',  function ($mdEditDialog, $scope, $timeout, $http, $mdDialog, $location, $routeParams, $mdPanel) {
	'use strict';
     ...
     $scope.creadtAsistenciaTemas = false;
    // ///////////////////////////////////////////
	$scope.datos = [];
	$scope.total = 0;

	$scope.loaddtAsistenciaTemass = function () {
	    //$scope.promise = $timeout(function () {
	    	...
	    	$scope.promise = $http.get(surl).then(function(res){
	    		 ...
	    		 $scope.creadtAsistenciaTemas = res.data.creamodifica;
	    		 console.log("data " +$scope.datos.length+" DE "+ $scope.total);
	    		 console.log("Tiempo respuesta BD dtAsistenciaTemas " +tiempoenBD+" Tiempo en Paginar "+tiempoenproceso);
				},
			...
			if(typeof(dato) != 'undefined'){
		            	$mdDialog.show(
						        ...
						        .title('Lista de Temas De La Asistencia')
						        .textContent(dato)
						        .ariaLabel('ERROR')
						        .ok('OK')
						    );
	  ...
	  $scope.getURLParametros=function(){
		  ...
		  return listadtAsistenciaTemasUrl+$scope.getURLParametros();
	  }
	  
	  $scope.editdtAsistenciaTemas = function () {
		    $scope.nuevo = true;
		    var idAsistTema = $routeParams.idAsistTema;
		    if(idAsistTema){
		    	$scope.cargardtAsistenciaTemas(idAsistTema);
		    }
		   ///CARGAR COMPLEMENTOS 
...
$scope.dtAsistenciaTemasModelo.estadoTxt = null;
		    ...
		    $scope.dtAsistenciaTemasModelo.editopcion = 1;
	 } 
...
$scope.dtAsistenciaTemasModelo.estadoTxt = dtAsistenciaTemasBk.estadoTxt;
			...
			$scope.dtAsistenciaTemasModelo.editopcion = dtAsistenciaTemasBk.dtAsistenciaTemasACL.editopcion;
		}
	  // ////////////////////////////////////////////////
	  $scope.editarDtAsistenciaTemas = function(ev, dtAsistenciaTemasBk) {		  
		    $scope.setDtAsistenciaTemasModelo(dtAsistenciaTemasBk);		  
			$location.url('/editar/' + $scope.dtAsistenciaTemasModelo.idAsistTema);
			$scope.nuevo = false;
	  }
	  
	  $scope.nuevoDtAsistenciaTemas = function() {
		    $scope.cleardtAsistenciaTemas();
			$location.url('/nuevo');
			$scope.nuevo = true;
	  }
	  	  
	  $scope.cancelarDtAsistenciaTemas = function() {
		    $scope.cleardtAsistenciaTemas();
		    $location.url('/');
	  }
	  			  
	  $scope.salvarDtAsistenciaTemas = function(ev){		
				    ev.target.disabled = true;
				    var datainsert = angular.toJson($scope.dtAsistenciaTemasModelo);
		 			console.log("datainsert = "+datainsert);	
		        		$http.post(insertdtAsistenciaTemasUrl,datainsert,{headers: {'Content-Type': 'application/json'}}).then(function(res){
							var dato = res.data;

//		    				$scope.datos.push(dato); 
		    				$scope.total = $scope.datos.length;
		    				
		    				$scope.setDtAsistenciaTemasModelo(dato);
		    				
		    				$mdDialog.show(
							         $mdDialog.alert()
							        .parent(angular.element(document.body))
							        .clickOutsideToClose(true)
							        .title('Guardar Temas De La Asistencia')
							        .textContent("del Temas De La Asistencia se guardó correctamente.")
							        .ariaLabel('ERROR')
							        .ok('OK')
							        .targetEvent(ev)
							    );
	   ...
	   $scope.eliminardtAsistenciaTemas = function(ev,dtAsistenciaTemasBk){		
			...
			if(typeof(dato) != 'undefined'){
					        ...
					        .parent(angular.element(document.body))
					        .clickOutsideToClose(true)
					        .title('Eliminar Temas De La Asistencia')
					        .textContent(dato)
					        .ariaLabel('ERROR')
					        .ok('OK')
					        .targetEvent(ev)
            ...
            $scope.activardtAsistenciaTemas = function(ev,dtAsistenciaTemasBk){		
				    ev.target.disabled = true;
				    $scope.setDtAsistenciaTemasModelo(dtAsistenciaTemasBk);
				    var datainsert = angular.toJson($scope.dtAsistenciaTemasModelo);
		 			console.log("Activar = "+datainsert);	
	        		$http.post(activardtAsistenciaTemasUrl,datainsert,{headers: {'Content-Type': 'application/json'}}).then(function(res){
						var dato = res.data;
						var instrumentos = $scope.datos;
				        var index = $scope.datos.findIndex(obj => obj.idAsistTema === dato.idAsistTema);
						console.log("INDEX " + index);
			...
			if(typeof(dato) != 'undefined'){
					        ...
					        .parent(angular.element(document.body))
					        .clickOutsideToClose(true)
					        .title('Activar Temas De La Asistencia')
					        .textContent(dato)
					        .ariaLabel('ERROR')
					        .ok('OK')
					        .targetEvent(ev)
            ...
            $scope.eliminarListadtAsistenciaTemas = function(ev){		
				    ev.target.disabled = true;
					...
					return;
				             ...
				             listaids.push($scope.selected[i].idAsistTema);
			                 }
                                    } 
				    
				    var datainsert = angular.toJson(listaids);
		 			console.log("Elimiar = "+datainsert);	
	        		$http.post(eliminarListadtAsistenciaTemasUrl,datainsert,{headers: {'Content-Type': 'application/json'}}).then(function(res){
						var dato = res.data;
						$mdDialog.show(
					$mdDialog.alert()
					.parent(angular.element(document.body))
		...
		$scope.cargardtAsistenciaTemas = function(idAsistTema){		
			var surl = editardtAsistenciaTemasUrl+idAsistTema;
			...
			if(typeof(dato) != 'undefined'){
					        ...
					        .parent(angular.element(document.body))
					        .clickOutsideToClose(true)
					        .title('Cargar Temas De La Asistencia')
					        .textContent(dato)
					        .ariaLabel('ERROR')
					        .ok('OK')
						   );
		...
		$scope.showConfirm = function(ev, dtAsistenciaTemasBk) {
                ...
                $scope.showConfirmActivar = function(ev, dtAsistenciaTemasBk) {
				    var confirm = $mdDialog.confirm()
				      .title('Activar Temas De La Asistencia')
				      .textContent('Esta usted seguro de activar el registro?')
				      .ariaLabel('Lucky day')
				    ...
				    $mdDialog.show(confirm).then(function () {
				      $scope.status = 'SI';
				      $scope.activardtAsistenciaTemas(ev, dtAsistenciaTemasBk);
				    }, function () {
				      $scope.status = 'NO';
				    });
				  };
                ...
                $scope.showConfirmLista = function(ev) {
				    ...
				    $mdDialog.show(confirm).then(function () {
				      $scope.status = 'SI';
				      $scope.eliminarListadtAsistenciaTemas(ev);
				    }, function () {
				      $scope.status = 'NO';
				    });
				  };		  
...
//SELECT INI
	...
	$scope.loadListaMsTemaIdTema=function(){
        ...
        $scope.$watch('dtAsistenciaTemasModelo.idTema', function (newValue, oldValue) {
		console.log('dtAsistenciaTemasModelo.idTema ' + newValue+' -- '+oldValue);
...
//SELECT INI
	...
	$scope.loadListaMsSubtemaIdSubtema=function(){
        ...
        $scope.$watch('dtAsistenciaTemasModelo.idSubtema', function (newValue, oldValue) {
		console.log('dtAsistenciaTemasModelo.idSubtema ' + newValue+' -- '+oldValue);
		//CARGAR DATOS DEL SIGUIENTE SELECT
...
///FIN ADICIONALES			 			 
	...
	$scope.monthFormat = $scope.buildLocaleProvider("MMM-YYYY");		    
		 ...
		 // Returns if a value is really a number
		    ...
		    $scope.nuevo = ($scope.isNumber($scope.dtAsistenciaTemasModelo.idAsistTema) && $scope.dtAsistenciaTemasModelo.idAsistTema > 0);
			$scope.edit  = true;
			...
			$scope.filtroDtAsistenciaTemas = function(toma){				
				const keys = Object.keys($scope.filtro);
				console.log('Filtro Keys '+keys);
				Object.keys($scope.filtro).forEach(key => {
					   console.log(key);
