...
angular.module('md-table-pagination.html', []).run(['$templateCache', function($templateCache) {
  $templateCache.put('md-table-pagination.html',
    ...
    '\n' +
    '  <md-button class="md-icon-button pbbutton" type="button" ng-if="$pagination.showBoundaryLinks()" ng-click="$pagination.first()" ng-disabled="$pagination.disabled || !$pagination.hasPrevious()" aria-label="First">\n' +
    '    <md-icon class="md-table-pagination-icon" md-font-set="material-icons">first_page</md-icon>\n' + 
    '  </md-button>\n' +
    '\n' +
    '  <md-button class="md-icon-button pbbutton" type="button" ng-click="$pagination.previous()" ng-disabled="$pagination.disabled || !$pagination.hasPrevious()" aria-label="Previous">\n' +
    '    <md-icon class="md-table-pagination-icon" md-font-set="material-icons">chevron_left</md-icon>\n' +
    '  </md-button>\n' +
    '\n' +
    '  <md-button class="md-icon-button pbbutton" type="button" ng-click="$pagination.next()" ng-disabled="$pagination.disabled || !$pagination.hasNext()" aria-label="Next">\n' +
    '    <md-icon class="md-table-pagination-icon" md-font-set="material-icons">chevron_right</md-icon>\n' +
    '  </md-button>\n' +
    '\n' +
    '  <md-button class="md-icon-button pbbutton" type="button" ng-if="$pagination.showBoundaryLinks()" ng-click="$pagination.last()" ng-disabled="$pagination.disabled || !$pagination.hasNext()" aria-label="Last">\n' +
    '    <md-icon class="md-table-pagination-icon" md-font-set="material-icons">last_page</md-icon>\n' +
    '  </md-button>\n' +
    '</div>');
}]);
...
function mdColumn($compile, $mdUtil) {
  ...
  function postLink(scope, element, attrs, ctrls) {
    ...
    function attachSortIcon() {
      var sortIcon = angular.element('<md-icon class="md-table-orden-icon" md-font-set="material-icons">arrow_upward');
